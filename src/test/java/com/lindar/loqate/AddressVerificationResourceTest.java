...
public class AddressVerificationResourceTest {
    ...
    public void findAddress_whenSuccessfulResponse_shouldParseDataResponse() {
        ...
        response.setServerResponse("{\"Items\":[{\"Id\":\"GB|RM|B|26772356\",\"Type\":\"Address\",\"Text\":\"Lock View, Basin Road\",\"Highlight\":\"\",\"Description\":\"Worcester, WR5 3DA\"},{\"Id\":\"GB|RM|B|53327590\",\"Type\":\"Address\",\"Text\":\"Lock Keepers Cottage, Basin Road\",\"Highlight\":\"\",\"Description\":\"Worcester, WR5 3DA\"},{\"Id\":\"GB|RM|B|52509479\",\"Type\":\"Address\",\"Text\":\"Loqate, Waterside, Basin Road\",\"Highlight\":\"\",\"Description\":\"Worcester, WR5 3DA\"}]}");
    ...
    public void findAddress_whenErrorResponse_shouldParseErrorResponse() {
        WellRestedResponse response = new WellRestedResponse();
        response.setServerResponse("{\"Items\":[{\"Error\":\"2\",\"Description\":\"Unknown key\",\"Cause\":\"The key you are using to access the service was not found.\",\"Resolution\":\"Please check that the key is correct. It should be in the form AA11-AA11-AA11-AA11.\"}]}");
        Mockito.when(requestFactory.makeRequest(any())).thenReturn(response);
